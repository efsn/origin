...
<body>
		...
		<table height="100px" width="650px" style="font-size:11px" border="0">				
			<tr>
				...
				<td>
					...
					<font size="3">
					<%
						String message = PryFactory.getPryQueryDao().getMessage((String)session.getAttribute("user"), "admin").get("message");
		...
		<form onsubmit="return isValid()" action="/sys/MessageFromAdminServlet" method="post">	
