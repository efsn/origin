...
<html>
<head>
<title>Expert Info Alter</title>
</head>
<body>		
    				<center>
    				<table height="40%" width="50%" style="font-size:11px" border="0" >
		    				<tr >
		    				...
		    				<tr>
		    					<td width="20%" align="center">		    						
		    						<p><font size="3" face="Courier" color="blue">姓名</font></p>
		    					</td>
		    				...
		    				<tr>
		    					<td width="20%" align="center">		    						
		    						<p><font size="3" face="Courier" color="blue">职称</font></p>
		    					</td>
		    					<td width="60%" align="center">		    						
		    					<p><font size="3">
		    				...
		    				<tr>
		    					<td width="20%" align="center">		    						
		    						<p><font size="3" face="Courier" color="blue">Email</font></p>
		    					</td>
		    					<td width="60%" align="center">		    						
		    					<p><font size="3">
		    				...
		    				<tr>
		    					<td width="20%" align="center">		    						
		    						<p><font size="3" face="Courier" color="blue">电话</font></p>
		    					</td>
		    					<td width="60%" align="center">		    						
		    						<p><font size="3">
		    				...
		    				<tr>
		    					...
		    					<td width="60%" align="center">		    						
		    					<p><font size="3">
		    					<%= ((ArrayList<String>)session.getAttribute("list")).get(4) %>
								</font></p>
		    					</td>
		    				</tr>					
		    			</table>
