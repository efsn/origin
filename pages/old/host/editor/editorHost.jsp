							...
							<img src="/sys/image/background/tg-logo.jpg"></img>
		    					...
		    					<td width="30%" align="right">
		    						<p><font size="3" face="楷体">
		    							欢迎进入<font color="blue">编辑首页</font>,&nbsp;
		    						</font>
				...
				<table height="50%" width="100%" style="font-size:11px" border="0" borderColor="#ffffff">
		    				...
		    				<tr>
		    					<td width="15%" align="center">
		    						<a href = "/sys/host/editor/editorInfoAlter.jsp" target="main">
		    				...
		    				<tr>
		    					<td align="center">
		    						<a href="/sys/host/essay/essayCheckOfEditor.jsp" target="main">
		    				...
		    				<tr>
		    					<td align="center">
		    						<a href="/sys/host/message/messageFromEditor.jsp" target="main">
		    				...
		    				<tr>
		    					<td align="center">
		    						<a href="/sys/host/editor/editorPwdAlter.jsp" target="main">
