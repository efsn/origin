  			...
  			<center> 		
	  	  		<table width="700px" style="font-size:11px" border="0">					
	  	  				<tr>
	  	  				 ...
	  	  				 <%
  							 Map<Integer, List<String>> value = PryFactory.getPryQueryAllDao().getEditorAll();
						  	 ...
						  	 if(pageNow == pageCount)
						  	 {
						  		 ...
						  		 for(Integer x : value.keySet())
						  		 {
									out.println("<tr>");
	  								...
	  								out.println("<td height=" + "30 align=" + "center" + ">");
	  								out.println("<font size='3'>");
	  								out.println("<a href=" + "/sys/host/delete/deleteEditor.jsp?editorId=" + x + ">删除</a>");
	  								out.println("</font>");
						  		...
						  		for(int i = (pageNow-1)*pageSize; i < pageNow*pageSize; i++)
							  	 {
	  								...
	  								out.println("<td height=" + "30 align=" + "center" + ">");
	  								out.println("<font size='3'>");
	  								out.println("<a href=" + "/sys/host/delete/deleteEditor.jsp?editorId=" + listKey.get(i) + ">删除</a>");
	  								out.println("</font>");
	  	  				...
	  	  				<td colspan = "5" align="center" bgcolor="lemonchiffon">
	  	  					<font size='3'>
	  	  					<%
								//上一页
								if(pageNow!=1)
								{
									out.println("<a href=editorAdmin.jsp?pageNow="+(pageNow-1)+">上一页</a>");
								}
								//显示超链接
								for(int i=1;i<=pageCount;i++)
								{
									out.println("<a href=editorAdmin.jsp?pageNow="+i+">["+i+"]</a>");
								}
								//下一页
								if(pageNow!=pageCount)
								{
									out.println("<a href=editorAdmin.jsp?pageNow="+(pageNow+1)+">下一页</a>");
								}
							%>
	  	  				</font>
	  	  				</td>	  	  							  	  				
