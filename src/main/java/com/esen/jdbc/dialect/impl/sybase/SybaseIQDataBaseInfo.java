...
public class SybaseIQDataBaseInfo extends AbstractDataBaseInfo {

  public SybaseIQDataBaseInfo(Connection conn, String defaultSchema) throws SQLException {
    super(conn, defaultSchema);
    this.dbtype = SqlConst.DB_TYPE_SYBASE_IQ;
