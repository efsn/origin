...
public class GBasePooledPreparedStatement extends GBasePooledStatement {

	public GBasePooledPreparedStatement(PooledConnection conn, PreparedStatement pstat, String sql) {
		super(conn, pstat, sql);
	}

	protected void setCharacterStream2(int parameterIndex, Reader reader, int length) throws SQLException {
