...
import com.esen.thread.ThreadPool;
...
public class SqlFunc {
	...
	private static final Logger log = LoggerFactory.getLogger(SqlFunc.class);

	public static final String[] KEYWORDS = { "ABORT", "ABS", "ABSOLUTE", "ACCESS", "ACTION", "ADA", "ADD", "ADMIN",
			"AFTER", "AGGREGATE", "ALIAS", "ALL", "ALLOCATE", "ALTER", "ANALYSE", "ANALYZE", "AND", "ANY", "ARE",
			"ARRAY", "AS", "ASC", "ASENSITIVE", "ASSERTION", "ASSIGNMENT", "ASYMMETRIC", "AT", "ATOMIC",
			"AUTHORIZATION", "AVG", "BACKUP", "BACKWARD", "BEFORE", "BEGIN", "BETWEEN", "BINARY", "BIT", "BITVAR",
			"BIT_LENGTH", "BLOB", "BOOLEAN", "BOTH", "BREADTH", "BREAK", "BROWSE", "BULK", "BY", "C", "CACHE", "CALL",
			"CALLED", "CARDINALITY", "CASCADE", "CASCADED", "CASE", "CAST", "CATALOG", "CATALOG_NAME", "CHAIN", "CHAR",
			"CHARACTER", "CHARACTERISTICS", "CHARACTER_LENGTH", "CHARACTER_SET_CATALOG", "CHARACTER_SET_NAME",
			"CHARACTER_SET_SCHEMA", "CHAR_LENGTH", "CHECK", "CHECKED", "CHECKPOINT", "CLASS", "CLASS_ORIGIN", "CLOB",
			...
			"COMMENT", "COMMIT", "COMMITTED", "COMPLETION", "COMPUTE", "CONDITION_NUMBER", "CONFIRM", "CONNECT",
			"CONNECTION", "CONNECTION_NAME", "CONSTRAINT", "CONSTRAINTS", "CONSTRAINT_CATALOG", "CONSTRAINT_NAME",
			"CONSTRAINT_SCHEMA", "CONSTRUCTOR", "CONTAINS", "CONTAINSTABLE", "CONTINUE", "CONTROLROW", "CONVERT",
			"COPY", "CORRESPONDING", "COUNT", "CREATE", "CREATEDB", "CREATEUSER", "CROSS", "CUBE", "CURRENT",
			...
			"DATETIME_INTERVAL_PRECISION", "DAY", "DBCC", "DEALLOCATE", "DEC", "DECIMAL", "DECLARE", "DEFAULT",
			"DEFERRABLE", "DEFERRED", "DEFINED", "DEFINER", "DELETE", "DELIMITERS", "DENY", "DEPTH", "DEREF", "DESC",
			"DESCRIBE", "DESCRIPTOR", "DESTROY", "DESTRUCTOR", "DETERMINISTIC", "DIAGNOSTICS", "DICTIONARY",
			"DISCONNECT", "DISK", "DISPATCH", "DISTINCT", "DISTRIBUTED", "DO", "DOMAIN", "DOUBLE", "DROP", "DUMMY",
			"DUMP", "DYNAMIC", "DYNAMIC_FUNCTION", "DYNAMIC_FUNCTION_CODE", "EACH", "ELSE", "ENABLED", "ENCODING",
			"ENCRYPTED", "END", "END-EXEC", "EQUALS", "ERRLVL", "ERROREXIT", "ESCAPE", "EVERY", "EXCEPT", "EXCEPTION",
			"EXCLUSIVE", "EXEC", "EXECUTE", "EXISTING", "EXISTS", "EXIT", "EXPLAIN", "EXTERNAL", "EXTRACT", "FALSE",
			"FETCH", "FILE", "FILLFACTOR", "FINAL", "FIRST", "FLOAT", "FLOPPY", "FOR", "FORCE", "FOREIGN", "FORTRAN",
			"FORWARD", "FOUND", "FREE", "FREETEXT", "FREETEXTTABLE", "FREEZE", "FROM", "FULL", "FUNCTION", "G",
			"GENERAL", "GENERATED", "GET", "GLOBAL", "GO", "GOTO", "GRANT", "GRANTED", "GROUP", "GROUPING", "HANDLER",
			"HAVING", "HIERARCHY", "HOLD", "HOLDLOCK", "HOST", "HOUR", "IDENTITY", "IDENTITYCOL", "IDENTITY_INSERT",
			"IF", "IGNORE", "ILIKE", "IMMEDIATE", "IMPLEMENTATION", "IN", "INCREMENT", "INDEX", "INDICATOR", "INFIX",
			"INHERITS", "INITIALIZE", "INITIALLY", "INNER", "INOUT", "INPUT", "INSENSITIVE", "INSERT", "INSTANCE",
			"INSTANTIABLE", "INSTEAD", "INT", "INTEGER", "INTERSECT", "INTERVAL", "INTO", "INVOKER", "IS", "ISNULL",
			"ISOLATION", "ITERATE", "JOIN", "K", "KEY", "KEY_MEMBER", "KEY_TYPE", "KILL", "LANCOMPILER", "LANGUAGE",
			"LARGE", "LAST", "LATERAL", "LEADING", "LEFT", "LENGTH", "LESS", "LEVEL", "LIKE", "LIMIT", "LINENO",
			"LISTEN", "LOAD", "LOCAL", "LOCALTIME", "LOCALTIMESTAMP", "LOCATION", "LOCATOR", "LOCK", "LOWER", "M",
			"MAP", "MATCH", "MAX", "MAXVALUE", "MESSAGE_LENGTH", "MESSAGE_OCTET_LENGTH", "MESSAGE_TEXT", "METHOD",
			"MIN", "MINUTE", "MINVALUE", "MIRROREXIT", "MOD", "MODE", "MODIFIES", "MODIFY", "MODULE", "MONTH", "MORE",
			"MOVE", "MUMPS", "NAME", "NAMES", "NATIONAL", "NATURAL", "NCHAR", "NCLOB", "NEW", "NEXT", "NO", "NOCHECK",
			"NOCREATEDB", "NOCREATEUSER", "NONCLUSTERED", "NONE", "NOT", "NOTHING", "NOTIFY", "NOTNULL", "NULL",
			"NULLABLE", "NULLIF", "NUMBER", "NUMERIC", "OBJECT", "OCTET_LENGTH", "OF", "OFF", "OFFSET", "OFFSETS",
			"OIDS", "OLD", "ON", "ONCE", "ONLY", "OPEN", "OPENDATASOURCE", "OPENQUERY", "OPENROWSET", "OPERATION",
			"OPERATOR", "OPTION", "OPTIONS", "OR", "ORDER", "ORDINALITY", "OUT", "OUTER", "OUTPUT", "OVER", "OVERLAPS",
			...
			"PARAMETER_SPECIFIC_SCHEMA", "PARTIAL", "PASCAL", "PASSWORD", "PATH", "PENDANT", "PERCENT", "PERM",
			"PERMANENT", "PIPE", "PLAN", "PLI", "POSITION", "POSTFIX", "PRECISION", "PREFIX", "PREORDER", "PREPARE",
			"PRESERVE", "PRIMARY", "PRINT", "PRIOR", "PRIVILEGES", "PROC", "PROCEDURAL", "PROCEDURE", "PROCESSEXIT",
			"PUBLIC", "RAISERROR", "READ", "READS", "READTEXT", "REAL", "RECONFIGURE", "RECURSIVE", "REF",
			"REFERENCES", "REFERENCING", "REINDEX", "RELATIVE", "RENAME", "REPEATABLE", "REPLACE", "REPLICATION",
			"RESET", "RESTORE", "RESTRICT", "RESULT", "RETURN", "RETURNED_LENGTH", "RETURNED_OCTET_LENGTH",
			"RETURNED_SQLSTATE", "RETURNS", "REVOKE", "RIGHT", "ROLE", "ROLLBACK", "ROLLUP", "ROUTINE",
			"ROUTINE_CATALOG", "ROUTINE_NAME", "ROUTINE_SCHEMA", "ROW", "ROWCOUNT", "ROWGUIDCOL", "ROWS", "ROW_COUNT",
			"RULE", "SAVE", "SAVEPOINT", "SCALE", "SCHEMA", "SCHEMA_NAME", "SCOPE", "SCROLL", "SEARCH", "SECOND",
			"SECTION", "SECURITY", "SELECT", "SELF", "SENSITIVE", "SEQUENCE", "SERIALIZABLE", "SERVER_NAME", "SESSION",
			"SESSION_USER", "SET", "SETOF", "SETS", "SETUSER", "SHARE", "SHOW", "SHUTDOWN", "SIMILAR", "SIMPLE",
			"SIZE", "SMALLINT", "SOME", "SOURCE", "SPACE", "SPECIFIC", "SPECIFICTYPE", "SPECIFIC_NAME", "SQL",
			"SQLCODE", "SQLERROR", "SQLEXCEPTION", "SQLSTATE", "SQLWARNING", "START", "STATE", "STATEMENT", "STATIC",
			"STATISTICS", "STDIN", "STDOUT", "STRUCTURE", "STYLE", "SUBCLASS_ORIGIN", "SUBLIST", "SUBSTRING", "SUM",
			"SYMMETRIC", "SYSID", "SYSTEM", "SYSTEM_USER", "TABLE", "TABLE_NAME", "TAPE", "TEMP", "TEMPLATE",
			"TEMPORARY", "TERMINATE", "TEXTSIZE", "THAN", "THEN", "TIME", "TIMESTAMP", "TIMEZONE_HOUR",
			"TIMEZONE_MINUTE", "TITLE", "TO", "TOAST", "TOP", "TRAILING", "TRAN", "TRANSACTION",
			"TRANSACTIONS_COMMITTED", "TRANSACTIONS_ROLLED_BACK", "TRANSACTION_ACTIVE", "TRANSFORM", "TRANSFORMS",
			"TRANSLATE", "TRANSLATION", "TREAT", "TRIGGER", "TRIGGER_CATALOG", "TRIGGER_NAME", "TRIGGER_SCHEMA",
			"TRIM", "TRUE", "TRUNCATE", "TRUSTED", "TSEQUAL", "TYPE", "UNCOMMITTED", "UNDER", "UNENCRYPTED", "UNION",
			"UNIQUE", "UNKNOWN", "UNLISTEN", "UNNAMED", "UNNEST", "UNTIL", "UPDATE", "UPDATETEXT", "UPPER", "USAGE",
			"USE", "USER", "USER_DEFINED_TYPE_CATALOG", "USER_DEFINED_TYPE_NAME", "USER_DEFINED_TYPE_SCHEMA", "USING",
			"VACUUM", "VALID", "VALUE", "VALUES", "VARCHAR", "VARIABLE", "VARYING", "VERBOSE", "VERSION", "VIEW",
			"WAITFOR", "WHEN", "WHENEVER", "WHERE", "WHILE", "WITH", "WITHOUT", "WORK", "WRITE", "WRITETEXT", "YEAR",
			"ZONE" };
	...
	public static final String getColumnName(Dialect dl, String cn) {
		...
		if (dl.getDataBaseInfo().getDbtype() == SqlConst.DB_TYPE_GREENPLUM
				|| dl.getDataBaseInfo().getDbtype() == SqlConst.DB_TYPE_GBASE_8T) {
			return cn;
		}
		if (SqlFunc.isKeyWord(cn)) {
	 ...
	 */
	public static final String generateTableName(DbDefiner db, Connection con, String tableNamePreFix) throws Exception {
	...
	public static final char getType(int sqlType, boolean throwException) {
		...
		if (r == 0 && throwException)
			...
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.unabletype", "不支持的字段类型 {0}"));
		return r;
	}

	/**
	 * 将表达式变量类型转换成sql类型；
	 * 支持字符，数值，日期，CLOB，BLOB类型；
	 * @param returnType
	 * @return
	 */
	...
	public static String[] readStrArray(ResultSet rs, int i) throws SQLException {
	...
	public static double[] readDoubleArray(ResultSet rs, int i) throws SQLException {
		DoubleArray dr = new DoubleArray(1024 * 5);
		while (rs.next())
			dr.add(rs.getDouble(i));
		return dr.toArray();
	...
	/**
	 * 如果只有一列，那么返回一个对应类型的数组
	 * 如果有多列，那么返回一个object[]数组，每个元素对应一列
	 */
	public static Object readArrayFromRS(ResultSet rs) throws SQLException {
		ResultSetMetaData rsmt = rs.getMetaData();
		if (rsmt.getColumnCount() == 1) {//为了效率 特殊处理字段是1的情况
			char coltype = SqlFunc.getType(rsmt.getColumnType(1));
			switch (coltype) {
				case 'N':
					return SqlFunc.readDoubleArray(rs, 1);
				case 'I':
					return SqlFunc.readIntArray(rs, 1);
				case 'C':
					return SqlFunc.readStrArray(rs, 1);
				default:
					//					throw new UnsupportedOperationException("不支持数值和字符型以外的其他类型的数组");
					throw new UnsupportedOperationException(I18N.getString("com.esen.jdbc.sqlfunc.unableother",
							"不支持数值和字符型以外的其他类型的数组"));
			}
		} else {
			return SqlFunc.readMultiDimArray(rs);//读取多维数组。
		}
	}
		...
		for (int i = 1; i <= types.length; i++) {
			...
			switch (t) {
				...
				default:
					...
					throw new UnsupportedOperationException(I18N.getString("com.esen.jdbc.sqlfunc.unsupportkind",
	...
	public final static boolean isCallalbe(String sql) {
		...
		Pattern p = Pattern.compile("\\s*((\\?|\\$\\w*)\\s*=)?\\s*\\{\\s*call\\s+.*\\}\\s*", Pattern.CASE_INSENSITIVE);
	 ...
	 * 
	 * 20100330
	 * 支持dbo.tablename, user.dbo.tablename 形式的表名；
	 * @param sql
	 * @return
	 */
	public final static String getTablename(String sql) {
		/*Pattern p = Pattern.compile("^\\s*+select\\s+\\*\\s+from\\s+([a-z]+([\\.]?[a-z_0-9\\$]+)*)\\s*$",
				Pattern.CASE_INSENSITIVE);*/
		
		/**
		 * 原始的reg:^\s*select\s*\*\s*from\s*([a-zA-Z\$]+[a-zA-Z0-9\$]*\.)*([a-zA-Z\$]+[a-zA-Z0-9\$]*)*\s*$
		 * 修改一处BUG,以前正则表达式在某些JVM上匹配"select * from T1E1648G802D1271P461A1496C1743 where isfile_ = 1"
		 * 这条SQL语句会卡死
		 */
	...
	public final static boolean isValidSymbol(String s) {
		if (s == null || s.length() == 0 || s.length() > 100)
			return false;
		Pattern p = Pattern.compile("[a-z]+([\\.]?[a-z_0-9\\$]+)*", Pattern.CASE_INSENSITIVE);
	...
	public final static boolean isUpdate(String sql) {
		...
		/**
		 * BI-5779 20110919 dw
		 * update语句中的表面可能带有schema前缀，原来的代码不能匹配这种表名，
		 * 造成写入数据调用setObject()，由于无法知道字段类型，写入null值出现异常；
		 */
		Pattern p = Pattern.compile("\\s*update\\s+([\\S]+)\\s+set\\s+.+", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		Matcher m = p.matcher(sql);
		return m.matches();
	}
	...
	public final static boolean isInsertInto(String sql) {
		if (sql == null || sql.length() < 12)
			return false;
		Pattern p = Pattern.compile("\\s*insert\\s+into\\s+\\w+.*", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		Matcher m = p.matcher(sql);
		return m.matches();
	}
	...
	public final static boolean isDelete(String sql) {
		if (sql == null || sql.length() < 12)
			return false;
		Pattern p = Pattern.compile("\\s*delete\\s+from\\s+\\w+.*", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		Matcher m = p.matcher(sql);
		return m.matches();
	}
	...
	public final static boolean isAlter(String sql) {
		if (sql == null || sql.length() < 12)
			return false;
		Pattern p = Pattern.compile("\\s*alter\\s+table\\s+\\w+.*", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		Matcher m = p.matcher(sql);
		return m.matches();
	}
	...
	public final static boolean isSelect(String sql) {
		if (sql == null || sql.length() < 15)
			return false;
		Pattern p = Pattern.compile("\\s*\\(*\\s*select\\s+.*\\s+from.+", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		Matcher m = p.matcher(sql);
		return m.matches();
	}

	/**
	 * 判断一个sql是否是create xxxx
	 * 这里只是简单的判断是否以create开始,以后如果需要再完善
	 */
	public final static boolean isCreate(String sql) {
		if (sql == null || sql.length() < 7)
			return false;
		Pattern p = Pattern.compile("\\s*create\\s+.*", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		return p.matcher(sql).matches();
	}

	/**
	 * 判断一个sql是否是drop xxx
	 * 这里只是简单的判断是否以drop开始，以后如果需要在完善
	 * @param sql
	 * @return
	 */
	public final static boolean isDrop(String sql) {
		if (sql == null || sql.length() < 5)
			return false;
		Pattern p = Pattern.compile("\\s*drop\\s+.*", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		return p.matcher(sql).matches();
	}

	/**
	 * 判断一个sql是否是rename xxx
	 * 这里只是简单的判断是否以drop开始，以后如果需要在完善
	 * @param sql
	 * @return
	 */
	public final static boolean isRename(String sql) {
		if (sql == null || sql.length() < 5)
			return false;
		Pattern p = Pattern.compile("\\s*rename\\s+.*", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		return p.matcher(sql).matches();
	}

	/**
	 * 判断一个sql是否是comment on xxx
	 * 这里只是简单的判断是否以comment on开始，以后如果需要再完善
	 * @param sql
	 * @return
	 */
	public final static boolean isComment(String sql) {
		if (sql == null || sql.length() < 8)
			return false;
		Pattern p = Pattern.compile("\\s*comment\\s+on\\s+.*", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
		return p.matcher(sql).matches();
	}
	...
	public final static Timestamp toSqlTimeStamp(Object x) {
		if (x == null || x instanceof Timestamp)
			return (Timestamp) x;
		if (x instanceof Date) {
			Date d = (Date) x;
			return new Timestamp(d.getTime());
		}
		Calendar cc = StrFunc.parseCalendar(x, null);
		if (cc == null)
			return null;
	...
	/**
	 * 将任意的类型转换成字符串类型；
	 * 包括：数字，字符，日期，clob,reader
	 * 其他：bolb,inputsteam 返回null
	 * @param x
	 * @return
	 * @throws SQLException 
	 */
	public final static String toSqlVarchar(Object x) throws SQLException {
		if (x == null || x instanceof String)
			return (String) x;
		if (x instanceof Integer || x instanceof Long || x instanceof Float || x instanceof Double || x instanceof Date
				|| x instanceof java.util.Date || x instanceof Time || x instanceof Timestamp)
			return x.toString();
	...
	private static final Pattern INSERT_ALLFIELD_REGEX = Pattern.compile(
			"^[\\s]*insert[\\s]+into[\\s]+([^\\s,\\(\\)]+)[\\s]+values[\\s]*\\(", Pattern.CASE_INSENSITIVE);
	...
	private static final Pattern UPDATE_SQL_REGEX = Pattern.compile(
			"^[\\s]*update[\\s]+([\\S]+)[\\s]+set([\\s]+[\\S].+)", Pattern.CASE_INSENSITIVE);

	// 匹配形如:field1=?的sql(符号包括>,=,<,>=,<=,like)
	/**
	 * 在匹配字段时需要注意字段两端有括号,如select Field1 from table where ((field2)=?,field3=?),这里获得字段时了需要从((field2)=?,field3=?)中取出字段field2,field3
	 */
	private static final Pattern UPDATE_FIELD = Pattern.compile(
	...
	public static final String getSelectSql(String sql) {
		/*
		 * ESENBI-2425: modify by liujin 2014.11.07
		 * 将 sql 语句中的换行改为空格，方便 SQL 语句处理。
		 */
		String sql_tmp = sql.replace('\n', ' ');
		StringBuffer sb = new StringBuffer("select ");
		/*Matcher insertAllField = INSERT_ALLFIELD_REGEX.matcher(sql);
		if (insertAllField.matches()) {
		...
		/*Matcher insertSomeField = INSERT_SOMEFIELD_REGEX.matcher(sql);
		if (insertSomeField.matches()) {
	...
	* jdbc:jtds:sqlserver://127.0.0.1:1433/orcdb;TDS=8.0;SendStringParametersAsUnicode=true
	* jdbc:mysql://127.0.0.1/orcdb
	* jdbc:oracle:thin:@127.0.0.1:1521:orcdb
	 */
	public final static String getIpAddressFromUrl(String url) {
		Pattern p = Pattern.compile("([1234567890]{1,3}\\.){3}[1234567890]{1,3}");
		Matcher mt = p.matcher(url);
		if (mt.find()) {
			return mt.group();
		}

		p = Pattern.compile("(\\:\\/\\/)([\\w|\\-|\\_]+)(\\:|\\/)", Pattern.CASE_INSENSITIVE);
		Matcher m = p.matcher(url);
		if (m.find()) {
			return m.group(2);
		}

		p = Pattern.compile("jdbc\\:sybase\\:Tds\\:([\\w|\\-|\\_]+)(\\:|\\/)", Pattern.CASE_INSENSITIVE);
		m = p.matcher(url);
		if (m.find()) {
			return m.group(1);
		}

		p = Pattern.compile("jdbc\\:oracle\\:thin\\:\\@([\\w|\\-|\\_]+)(\\:|\\/)", Pattern.CASE_INSENSITIVE);
		m = p.matcher(url);
		if (m.find()) {
			return m.group(1);
		}
	...
	public static String checkJdbc(MiniProperties props) {
		...
		/**
		 * 如果没有第三方连接池，则检查连接池的参数；
		 * 主要是url中是否有指定编码、日志级别是否太低；
		 */
		if (StrFunc.isNull(ds3str)) {
			String driverclass = props.getProperty(PoolPropName.PROP_DRIVERCLASSNAME);
			...
			if (driverclass.indexOf("mysql") > 0) {
				if (url.indexOf("characterEncoding") < 0) {
					...
					sb.append(I18N.getString("com.esen.jdbc.sqlfunc.mysqlmischarset",
			...
			if (driverclass.indexOf("sybase") > 0) {
				...
				if (url.indexOf("charset") < 0) {
					...
					sb.append(I18N.getString("com.esen.jdbc.sqlfunc.sybasemischarset", "Sybase连接池url没有指定编码参数charset;\n"));
				}
			}

			if (!StrFunc.isNull(levstr) && levstr.equalsIgnoreCase("debug")) {
				sb.append(I18N.getString("com.esen.jdbc.sqlfunc.leveladvise", "连接池日志级别现在是debug级，建议改成error级别；\n"));
			}
		}
		if (sb.length() > 0) {
			return sb.toString();
	...
	public static final String getDbType(String driverClassName) {
		if (!StrFunc.isNull(driverClassName)) {
	...
	/**
	 * 通过连接池对象判断是否是mdx服务器。
	 * 此方法不需要启动连接池，即使mdx服务器无法访问，也可以保证很快的判断此连接池是不是mdx服务器；
	...
	public static final boolean isMdx(ConnectionFactory conf) {
		if (conf == null) {
			...
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.unknownmdx", "连接池对像为空，无法判断是否是mdx服务器；"));
		}
		/*
		 *add by jzp 2013.4.25 
		 *当不是poolconnectionFactory时 直接返回false;
		 */
		if (!(conf instanceof PoolConnectionFactory))
			return false;
	...
	public static final boolean isGreenplum(ConnectionFactory conf) {
		if (conf == null) {
			...
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.unknownGreenplum",
	...
	/**
	 * 通过连接池url判断是否是Greenplum数据库。
	 * 可能驱动是 jdbc:postgresql 不只一种 此处可能有点误差
	 * @param url
	 * @return
	 */
	...
	public static final boolean isNetezza(ConnectionFactory conf) {
		if (conf == null) {
			...
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.unknownNetezza",
	...
	public static final boolean isGBase(ConnectionFactory conf) {
		if (conf == null) {
			//			throw new RuntimeException("连接池对像为空，无法判断是否是Netezza服务器；");
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.unknownGBase", "连接池对像为空，无法判断是否是GBase服务器；"));
		}
		/*
		 *add by jzp 2013.4.25 
		 *当不是poolconnectionFactory时 直接返回false;
	...
	/**
	   ...
	   * @return
	   */
	public static boolean compareConnection(Connection srccon, Connection destcon) {
		DataBaseInfo db1 = DataBaseInfo.createInstance(srccon);
		DataBaseInfo db2 = DataBaseInfo.createInstance(destcon);
		if (db1.getJdbcurl().equals(db2.getJdbcurl()) && db1.getUserName().equals(db2.getUserName())) {
			return true;
		}
		return false;
	}
	 ...
	 * @return
	 */
	public static final void testConnect(ConnectionFactory fct) throws Exception {
		if (fct == null)
			//			throw new Exception("ConnectionFactory为空,无法获取连接。");
			throw new Exception(I18N.getString("com.esen.jdbc.sqlfunc.nullconnf", "ConnectionFactory为空,无法获取连接。"));
		Connection con = fct.getConnection();
		try {
			if (con == null) {
				//				throw new Exception("无法获取连接。");
				throw new Exception(I18N.getString("com.esen.jdbc.sqlfunc.unablegetconn", "无法获取连接。"));
			}
		} finally {
			if (con != null)
				con.close();
	 ...
	 * @return 
	 */
	public static final boolean tableOrViewExist(ConnectionFactory fct, String table, boolean throwException) {
		if (StrFunc.isNull(table))
			return false;
		try {
			Connection con = fct.getConnection();
			try {
				return tableOrViewExist(con, fct.getDbDefiner(), table, throwException);
			} finally {
				con.close();
			}
		} catch (Exception e) {
	...
	public static final boolean tableOrViewExist(Connection con, DbDefiner dd, String table, boolean throwException) {
		if (StrFunc.isNull(table))
			return false;
		try {
	 ...
	 * @throws Exception
	 */
	public static final String createTable(ConnectionFactory fct, String table, Class c, String xml) throws Exception {
		if (StrFunc.isNull(table) || StrFunc.isNull(xml))
			return null;
	...
	public static final String createTable(Connection con, DbDefiner dd, String table, Class c, String xml)
			throws Exception {
		if (StrFunc.isNull(table) || StrFunc.isNull(xml))
			return null;
		Document doc = null;
	...
	public static final String createTable(ConnectionFactory fct, String table, String xml) throws Exception {
		return createTable(fct, table, SqlFunc.class, xml);
	}

	public static final String createTable(Connection con, DbDefiner dd, String table, String xml) throws Exception {
		return createTable(con, dd, table, SqlFunc.class, xml);
	}
	 ...
	 * @throws Exception 
	 */
	public static final void dropTable(ConnectionFactory fct, String table) throws Exception {
		//如果表为空或无效的表名,则不会作任何处理
		if (StrFunc.isNull(table) || !SqlFunc.isValidSymbol(table)) {
			return;
		}
		DbDefiner dd = fct.getDbDefiner();
		Connection con = fct.getConnection();
	 ...
	 * @throws Exception
	 */
	public static void dropTable(Connection con, DbDefiner dd, String table) throws Exception {
		/**
		 * 可能表或视图不存在或被前面的代码已经删除了，此时应该忽略他们。
		 */
		if (dd.tableExists(con, null, table)) {
			//			log.info("删除数据库表{}", table);
			log.info(I18N.getString("com.esen.jdbc.SqlFunc.java.comp1", "删除数据库表{}"), table);
			dd.dropTable(con, null, table);
		} else if (dd.viewExists(con, table)) {
			//			log.info("删除视图{}", table);
			log.info(I18N.getString("com.esen.jdbc.SqlFunc.java.comp2", "删除视图{}"), table);
			dd.dropView(con, table);
		} else {
			//			log.info("表或视图{}不存在，忽略它", table);
			log.info(I18N.getString("com.esen.jdbc.SqlFunc.java.comp3", "表或视图{}不存在，忽略它"), table);
		}
	}

	/**
	 * 测试数据库连接  允许指定超时时间
	 * 这里的数据库连接超时不是在jdbc层面实现的，而是通过的Future的get方法来指定超时的时间
	 * @param props 数据库连接池的相关属性
	 * @param pool 线程池对象
	 * @param millsec 超时时间  秒
	 * @throws Exception 
	 */
	public static final void testDatasourceWithTimeout(final MiniProperties props, ThreadPool pool, long sec)
			throws Exception {
		Future f = pool.execute(new Callable<Exception>() {
			public Exception call() throws Exception {
				try {
					SqlFunc.testDataSource(props);
					return null;
				} catch (Exception e) {
					return e;
				}
		...
		try {
			...
			throw new RuntimeException4I18N("com.esen.jdbc.sqlfunc.1","连接超时", ex);
		}
		if (e != null) {
			throw e;
		}
	...
	/**
	   ...
	   * @throws Exception 
	   */
	public static final void testDataSource(MiniProperties props) throws Exception {
		if (props == null) {
			//			throw new RuntimeException("测试失败,缺少JDBC连接属性.");
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.testerr1", "测试失败,缺少JDBC连接属性."));
		}
		...
		String password = StrFunc.decryptPlainPassword(props.getString(PoolPropName.PROP_PASSWORD, ""));
		if (StrFunc.isNull(url)) {
			//			throw new RuntimeException("测试失败,缺少参数(" + PoolPropName.PROP_URL + ").");
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.testerr2", "测试失败,缺少参数({0}).",
					new Object[] { PoolPropName.PROP_URL }));
		}
		if (StrFunc.isNull(driver)) {
			//throw new RuntimeException("测试失败,缺少参数(" + PoolPropName.PROP_DRIVERCLASSNAME + ").");
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.testerr2", "测试失败,缺少参数({0}).",
		...
		try {
			...
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.testerr3", "测试失败,找不到驱动类库({0}).",
					new Object[] { driver }), ex);
		}
		url = DefaultConnectionFactory.convertDbUrl(url);
		java.sql.Connection _conn = null;
		try {
			_conn = java.sql.DriverManager.getConnection(url, username, password);
		} catch (Exception e) {
			//			throw new RuntimeException("测试失败,无法获得数据库链接.\r\n"+e.toString()+"\r\n"+e.getMessage());
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.testerr4",
					"测试失败,无法获得数据库链接.\r\n{0}\r\n{1}", new Object[] { e.toString(), e.getMessage() }), e);
		}
		if (_conn == null) {
			//			throw new RuntimeException("测试失败,无法获得数据库链接.");
			throw new RuntimeException(I18N.getString("com.esen.jdbc.sqlfunc.testerr5", "测试失败,无法获得数据库链接."));
		}
		try {
			if (!StrFunc.isNull(catalog))
	 ...
	 * @throws Exception
	 */
	public static boolean dropProcedure(Connection conn, String Name) throws Exception {
		if (conn == null) {
			//无法获取连接
			throw new Exception(I18N.getString("com.esen.jdbc.sqlfunc.unablegetconn", "无法获取连接。"));
		}
	...
	* @throws Exception
	*/
	public static boolean createProcedure(Connection conn, String Name, String sql) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static int execute_procedure(Connection conn, String procedure) throws Exception {
		conn.setAutoCommit(false);
