...
public final class ArrayUtil {
    ...
    /**
     * hash算法，一般在获得对象hashcode时使用 使用老的hash值加一个字符串生成一个新的hash代码，使用该算法可以提高生产hash的效率
    ...
    public static final boolean compareArray(String[] ar1, String[] ar2) {
        ...
        for (int i = 0, len = ar1.length; i < len; i++) {
            if (!StrUtil.compareStr(ar1[i], ar2[i])) return false;
        }
        return true;
    }
    ...
    public static final int[] merge(int[] a1, int[] a2) {
        ...
        int[] a = new int[l1 + l2];
        if (l1 != 0) System.arraycopy(a1, 0, a, 0, l1);
        if (l2 != 0) System.arraycopy(a2, 0, a, l1, l2);
        return a;
    }
    ...
    public static final Object[] merge(Object[] o1, Object[] o2) {
        ...
        if (l1 + l2 == 0) return null;
        Object[] r = (Object[]) Array
                .newInstance(o1 == null ? o2.getClass().getComponentType() : o1
                        .getClass().getComponentType(), l1 + l2);
        if (o1 != null) {
    ...
    public static final String[] distinct(String[] ss) {
        ...
        for (int i = 0; i < ss.length; i++) {
            if (!dist.contains(ss[i])) dist.add(ss[i]);
        }
    ...
    public static final <E> void bubbleSort(E[] list, Comparator<E> compare) {
        ...
        for (int i = 0; i < list.length; i++) {
            for (int j = i + 1; j < list.length; j++) {
                if (compare.compare(list[i], list[j]) > 0) swap(list, i, j);
            }
        }
    }
    ...
    public static final Object[] excludeNull(Object[] os) {
        ...
        Object[] r = (Object[]) Array.newInstance(os.getClass()
                .getComponentType(), j);
    ...
    public static String doublearray2Str(double[] list, char sept) {
        ...
        for (int i = 0; i < list.length; i++) {
            ...
            if (i < list.length - 1) sb.append(sept);
        }
        return sb.toString();
    }
    ...
    public static final Object subElement(Object source, int off, int len) {
        ...
        if (!source.getClass().isArray()) {
            ...
            throw new RuntimeException(I18N.getString(
                    "com.esen.util.ArrayFunc.1", "源对象不是数组 "));
        }
        ...
        Object ods = Array.newInstance(source.getClass().getComponentType(),
                len);
    ...
    public static final void reverse(Object a) {
        ...
        if (cls.isArray()) {
            ...
            if (cls == double.class) {
                ArrayUtil.reverse((double[]) a);
            } else if (cls == int.class) {
                ArrayUtil.reverse((int[]) a);
            } else if (cls == long.class) {
                ArrayUtil.reverse((long[]) a);
            } else if (Object.class.isAssignableFrom(cls)) {
                ArrayUtil.reverse((Object[]) a);
            } else {
    ...
    public static final int count(Object a, boolean distinct) {
        ...
        if (cls.isArray()) {
            cls = cls.getComponentType();
            if (cls == double.class) {
                return ArrayUtil.count((double[]) a, distinct);
            } else if (cls == int.class) {
                return ArrayUtil.count((int[]) a, distinct);
            } else if (cls == long.class) {
                return ArrayUtil.count((long[]) a, distinct);
            } else if (Object.class.isAssignableFrom(cls)) {
                return ArrayUtil.count((Object[]) a, distinct);
            } else {
    ...
    public static Object[] array2ObjArray(Object items) {
        ...
        if (ct == int.class || ct == long.class || ct == double.class
                || ct == byte.class || ct == char.class || ct == short.class
                || ct == float.class || ct == boolean.class) {
            int len = Array.getLength(items);
    ...
    public static Object setCapacity(Object ar, int capacity) {
        ...
        Object nar = java.lang.reflect.Array.newInstance(ar.getClass()
                .getComponentType(), capacity);
    ...
    public static Object[] list2array(Collection list, Class c) {
        ...
        if (c == null) {
            ...
            if (obj == null) {
                ...
                throw new RuntimeException(I18N.getString(
                        "com.esen.util.ArrayFunc.2", "元素都为null"));
            }
            c = obj.getClass();
        }
    ...
    // public static int indexOf(byte[] source, int sourceOffset, int
    // sourceCount, byte[] target, int targetOffset,
    ...
    public static int indexOf(Object source, int sourceOffset, int sourceCount,
        ...
        if (sourceOffset >= sourceCount) {
            ...
            throw new RuntimeException(I18N.getString(
                    "com.esen.util.ArrayFunc.7", "源数组开始查找位置大于源数组长度 "));
        }
        if (targetOffset >= targetCount) {
            // throw new RuntimeException("目标开始查找位置大于目标数组长度");
            throw new RuntimeException(I18N.getString(
                    "com.esen.util.ArrayFunc.8", "目标开始查找位置大于目标数组长度 "));
