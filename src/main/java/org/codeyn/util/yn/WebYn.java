...
public class WebYn {
     ...
     * @param out
     * @param path 图片相对路径。
     * @param msgs 要显示的信息。每条显示在一行。 信息的格式中支持超链接。格式是: new String[]{ "你没有查看任务组的权限。",
     ...
     *
     * @param id    报表户信息,不能为空
     * @param btype 报表户类型,不能为空
     * @param group 任务组名,不能为空
     * @param login Login对象,可以为空
     * @param conn  数据库连接,可以为空
     * @return 可能返回null
     * @throws Exception
     * @throws Exception
     */
     ...
     *
     * @param brow    bbhBrowse实例
     * @param bbq     报表期
     * @param upid    上级ID
     * @param rec     是否递归
     * @param bbhList 报表户列表容器
     * @throws Exception
     */
     ...
     *
     * @param out
     * @param relPath oemJsPath相对于当前页面路径的相对路径。
     * @param jsFile  含相对路径的js文件名(相对于oemJsPath下js文件夹的路径)
     * @throws IOException
     */
