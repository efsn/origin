...
public final class ExceptionHandler {
   ...
   */
  static public void rethrow(Exception ex, String key,String defaultValue,Object[] params)throws Exception{
    Exception e = new Exception4I18N(key,defaultValue,ex);
    e.setStackTrace(ex.getStackTrace());
    throw e;
  }
  
  static public void rethrow(Exception ex, String key,String defaultValue)throws Exception{
  ...
  static public void rethrowRuntimeException(Throwable ex, String msg){
    ...
    /**
     * 由于系统中有很多地方rethrowRuntimeException的异常又被上层的函数再次rethrowRuntimeException，有时达到4~5此之多，
     * 导致同一个异常在控制台可能输出4~5边，故不应该在这里log异常，而应该在需要的地方自己处理。
     */
    //log.warn(msg, ex);
     ...
     */
    if(ex instanceof RuntimeException && ex.getClass()!=RuntimeException.class){
   ...
   */
	static public void rethrowRuntimeException(Throwable ex, String key, String defaultValue, Object[] params) {
		if (ex == null) {
		...
		RuntimeException e = new RuntimeException4I18N(key, defaultValue, params, ex);
		e.setStackTrace(ex.getStackTrace());
		throw e;
	}

	static public void rethrowRuntimeException(Throwable ex, String key, String defaultValue) {
  ...
  static public void rethrowRuntimeException(Throwable ex){
	  /**
		 * 20110317 ISSUE:BI-4300 当主题域或主题集对应的数据库连接池连不上时为何提示“java.lang.RuntimeException”？
    ...
    if(ex instanceof Exception4I18N){
    	...
    	RuntimeException4I18N e18n = new RuntimeException4I18N(e.getMessageKey(),e.getDefaultValue(),e.getParams());
	...
	public static void throwRuntimeException(String key, String defaultValue, Object[] params) {
		/**
		 * 由于系统中有很多地方rethrowRuntimeException的异常又被上层的函数再次rethrowRuntimeException，有时达到4~5此之多，
		 * 导致同一个异常在控制台可能输出4~5边，故不应该在这里log异常，而应该在需要的地方自己处理。
		 */
