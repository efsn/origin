...
public class CSVWriter{
    ...
    /**
     * 写一行数据 Object 类型可以是：String,Number,Date,Time,Timestamp,Clob,Reader;
     * Date格式：yyyy-MM-dd Time格式：HH:mm:ss Timestamp格式：yyyy-MM-dd HH:mm:ss
     * Clob,Reader 将转换为字符串存储； 其他类型都存储空值；
     * 
     * @param o
     * @return
     */
    ...
    /**
     * 4.字段中包含有逗号，该字段必须用双引号括起来 5.字段中包含有换行符，该字段必须用双引号括起来 6.字段前后包含有空格，该字段必须用双引号括起来
