...
public final class MacAddress {
  /**
   * windows:
   * Physical Address. . . . . . . . . : 00-13-02-9A-A2-3B
   * 
   * linux :
   * eth0      Link encap:Ethernet  HWaddr 00:10:5C:FC:B2:7C  
          BROADCAST MULTICAST  MTU:1500  Metric:1
          RX packets:0 errors:0 dropped:0 overruns:0 frame:0
          TX packets:0 errors:0 dropped:0 overruns:0 carrier:0
          collisions:0 txqueuelen:1000 
          RX bytes:0 (0.0 b)  TX bytes:0 (0.0 b)
          Base address:0xd880 Memory:fe980000-fe9a0000 
...
en0   1500  link#2      0.11.25.8.1d.81   21609570     0  3880375     3     0
en0   1500  150.100.16  150.100.16.183    21609570     0  3880375     3     0
lo0   16896 link#1                           95267     0    95830     0     0
lo0   16896 127         127.0.0.1            95267     0    95830     0     0
lo0   16896 ::1                              95267     0    95830     0     0
...
0/0/12/0/0/0/0/4/0/0/0 0xD8D385F667D3 2   UP    lan2 snap2     3   ETHER     Yes     119
0/0/12/0/0/0/0/4/0/0/1 0xD8D385F667D2 3   UP    lan3 snap3     4   ETHER     Yes     119
0/0/14/0/0/0/0/2/0/0/0 0x3C4A923B191C 4   UP    lan4 snap4     5   ETHER     Yes     119
0/0/14/0/0/0/0/2/0/0/1 0x3C4A923B191D 5   UP    lan5 snap5     6   ETHER     Yes     119
1/0/0/1/0 0x1CC1DE104797 6   UP    lan6 snap6     7   ETHER     Yes     119
...
LinkAgg0 0xD8D385F667D1 900 UP    lan900 snap900 15  ETHER     Yes     119
LinkAgg1 0xD8D385F667D0 901 UP    lan901 snap901 16  ETHER     Yes     119
LinkAgg2 0x000000000000 902 DOWN  lan902 snap902 17  ETHER     Yes     119
...
LinkAgg4 0x000000000000 904 DOWN  lan904 snap904 19  ETHER     Yes     119
   */
  static private List collectHWaddr_ByCMD(List r) {
    if (r==null)
      r = new ArrayList(3);
    try {
  ...
  static private List collectHWaddr_ByConfigFile(List r) {
    if (r==null)
      r = new ArrayList(3);
    try {
      boolean linux = File.separatorChar=='/';
  ...
  private static void collectMacAddressFromString(List r, String s) {
    ...
    while (mt.find(end)){
      ...
      if ("00:00:00:00:00:00".equals(addr))//我的win7上有蛮多这个信息，去掉他们
    	  continue;
      /**
       * BI-6163 00:50:56:C0:00 排除以该网址打头的地址，这些地址应该都是虚拟网卡生成的。
       */
  ...
  public static final List collectHWaddr(){
    List r = collectHWaddr_ByConfigFile(null);
    r = collectHWaddr_ByCMD(r);
    return r;
  }
  ...
  public static void main(String[] args) {
    System.out.println(ArrYn.array2displaystr(getMacAddresses()));
    System.out.println(ArrYn.array2displaystr(getMacAddresses()));
  }
}
